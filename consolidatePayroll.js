//Creates a single object with all payroll data from a CSV, using employee and account lookup objects
//This object will then create a single Journal Entry in NetSuite.
